...
<html lang="en">
<head>
	<title>About Us - Road Representive</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-55 p-b-70">
			...
			<li class="t-center m-b-20">
				<a href="committee.html" class="txt19">The Committee</a>
			</li>

			<li class="t-center m-b-20">
				<a href="gallery.html" class="txt19">Road Representative</a>
			</li>

			<li class="t-center m-b-20">
				<a href="about.html" class="txt19">Auditors</a>
			</li>
	...
	<!-- committee -->
	<section class="section-chef bgwhite p-t-220 p-b-95">
