...
<head>
  ...
  <title>Admin - Success</title>
    <meta name="description" content="Admin - Success">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-menu" aria-controls="main-menu" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <a class="navbar-brand" href="index.php"><img src="images/logo.png" width="1   00" height="100" alt="Logo"></a>
                         ...
                         <form action="index.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                             <div class="row form-group">
                              ...
                              <div class="card-footer">
                                ...
                                <i class="fa fa-dot-circle-o"></i> Back to home page
                                    </button>
